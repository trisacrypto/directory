...
func (c *trtlClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetReply, error) {
	out := new(GetReply)
	err := c.cc.Invoke(ctx, Trtl_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trtlClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutReply, error) {
	out := new(PutReply)
	err := c.cc.Invoke(ctx, Trtl_Put_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trtlClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteReply, error) {
	out := new(DeleteReply)
	err := c.cc.Invoke(ctx, Trtl_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trtlClient) Iter(ctx context.Context, in *IterRequest, opts ...grpc.CallOption) (*IterReply, error) {
	out := new(IterReply)
	err := c.cc.Invoke(ctx, Trtl_Iter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trtlClient) Batch(ctx context.Context, opts ...grpc.CallOption) (Trtl_BatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Trtl_ServiceDesc.Streams[0], Trtl_Batch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *trtlClient) Cursor(ctx context.Context, in *CursorRequest, opts ...grpc.CallOption) (Trtl_CursorClient, error) {
	stream, err := c.cc.NewStream(ctx, &Trtl_ServiceDesc.Streams[1], Trtl_Cursor_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *trtlClient) Sync(ctx context.Context, opts ...grpc.CallOption) (Trtl_SyncClient, error) {
	stream, err := c.cc.NewStream(ctx, &Trtl_ServiceDesc.Streams[2], Trtl_Sync_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
