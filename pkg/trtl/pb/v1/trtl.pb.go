...
type Options struct {
	...
	RequireNotExists bool   `protobuf:"varint,6,opt,name=require_not_exists,json=requireNotExists,proto3" json:"require_not_exists,omitempty"` // on a write, ensure the key does not exist before writing
	RequireExists    bool   `protobuf:"varint,7,opt,name=require_exists,json=requireExists,proto3" json:"require_exists,omitempty"`            // on a write or delete, ensure key exists before updating
}
...
func (x *Options) GetRequireNotExists() bool {
	if x != nil {
		return x.RequireNotExists
	}
	return false
}

func (x *Options) GetRequireExists() bool {
	if x != nil {
		return x.RequireExists
	}
	return false
}
...
var file_trtl_v1_trtl_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x72, 0x74, 0x6c,
	...
	0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x72, 0x74, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x75, 0x74,
	...
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x74, 0x72, 0x74, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x48, 0x00, 0x52, 0x03, 0x67, 0x65, 0x74, 0x12, 0x25, 0x0a, 0x03,
	0x70, 0x75, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x74, 0x72, 0x74, 0x6c,
	...
	0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x74, 0x72, 0x74, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65,
	...
	0x0b, 0x32, 0x12, 0x2e, 0x74, 0x72, 0x74, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x74, 0x65, 0x72,
	...
	0x6c, 0x69, 0x63, 0x61, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x74, 0x72, 0x74,
	0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x53, 0x74, 0x61, 0x74,
	...
	0x52, 0x05, 0x73, 0x69, 0x67, 0x6d, 0x61, 0x22, 0x83, 0x02, 0x0a, 0x07, 0x4f, 0x70, 0x74, 0x69,
	...
	0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x2c, 0x0a, 0x12, 0x72, 0x65, 0x71, 0x75,
	0x69, 0x72, 0x65, 0x5f, 0x6e, 0x6f, 0x74, 0x5f, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x4e, 0x6f, 0x74,
	0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72,
	0x65, 0x5f, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d,
	0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x22, 0x71, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x32, 0xee, 0x03, 0x0a,
	...
	0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x12, 0x35,
	...
	,
...
func file_trtl_v1_trtl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_trtl_v1_trtl_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KVPair); i {
			case 0:
				return &v.state
			case 1:
		...
		file_trtl_v1_trtl_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Meta); i {
			case 0:
				return &v.state
			case 1:
		...
		file_trtl_v1_trtl_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_trtl_v1_trtl_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
	...
	file_trtl_v1_trtl_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*SyncRequest_Get)(nil),
		(*SyncRequest_Put)(nil),
