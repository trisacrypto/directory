...
// UnimplementedPeerManagementServer must be embedded to have
...
func (UnimplementedPeerManagementServer) AddPeers(context.Context, *Peer) (*PeersStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method AddPeers not implemented")
}
func (UnimplementedPeerManagementServer) RmPeers(context.Context, *Peer) (*PeersStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method RmPeers not implemented")
}
func (UnimplementedPeerManagementServer) mustEmbedUnimplementedPeerManagementServer() {}
func (UnimplementedPeerManagementServer) testEmbeddedByValue()                        {}
...
func RegisterPeerManagementServer(s grpc.ServiceRegistrar, srv PeerManagementServer) {
	// If the following call panics, it indicates UnimplementedPeerManagementServer was
