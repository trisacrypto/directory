...
func invite_userHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "invite_user.html", size: 1077, mode: os.FileMode(0644), modTime: time.Unix(1790190147, 0)}
...
func invite_userTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "invite_user.txt", size: 928, mode: os.FileMode(0644), modTime: time.Unix(1790190147, 0)}
