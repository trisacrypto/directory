...
func invite_userHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "invite_user.html", size: 872, mode: os.FileMode(0644), modTime: time.Unix(1668464327, 0)}
...
func invite_userTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "invite_user.txt", size: 726, mode: os.FileMode(0644), modTime: time.Unix(1668464327, 0)}
