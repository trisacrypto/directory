...
type RegistrationForm struct {
	...
	Entity *ivms101.LegalPerson `protobuf:"bytes,9,opt,name=entity,proto3" json:"entity,omitempty"`
	// Directory Record contacts
	Contacts *v1beta1.Contacts `protobuf:"bytes,10,opt,name=contacts,proto3" json:"contacts,omitempty"`
	// TRIXO Form
	Trixo *v1beta1.TRIXOQuestionnaire `protobuf:"bytes,11,opt,name=trixo,proto3" json:"trixo,omitempty"`
	// Network-specific information and submission details
	Testnet *NetworkDetails `protobuf:"bytes,12,opt,name=testnet,proto3" json:"testnet,omitempty"`
	Mainnet *NetworkDetails `protobuf:"bytes,13,opt,name=mainnet,proto3" json:"mainnet,omitempty"`
	// Metadata as RFC3339 Timestamps
	Created  string `protobuf:"bytes,14,opt,name=created,proto3" json:"created,omitempty"`
	Modified string `protobuf:"bytes,15,opt,name=modified,proto3" json:"modified,omitempty"`
}
...
func (x *RegistrationForm) GetCreated() string {
	if x != nil {
		return x.Created
	}
	return ""
...
func (x *RegistrationForm) GetModified() string {
	if x != nil {
		return x.Modified
	}
	return ""
...
func (x *NetworkDetails) GetSubmitted() string {
	if x != nil {
		return x.Submitted
	}
	return ""
...
var file_bff_models_v1_models_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x4a, 0x04, 0x08, 0x0c, 0x10, 0x0d, 0x22, 0x75,
	...
	0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xaf, 0x04, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x65, 0x73, 0x74, 0x61, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x64, 0x4f, 0x6e, 0x12, 0x2c, 0x0a,
	0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	...
	0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e,
	...
	0x72, 0x69, 0x78, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x74, 0x72, 0x69,
	...
	0x37, 0x0a, 0x07, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6e, 0x65, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x62, 0x66, 0x66, 0x2e,
	...
	0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x0e, 0x4e, 0x65, 0x74, 0x77,
	...
	0x61, 0x6d, 0x65, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74, 0x65,
	0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74,
...
var file_bff_models_v1_models_proto_goTypes = []interface{}{
	...
	(v1beta1.BusinessCategory)(0),      // 4: trisa.gds.models.v1beta1.BusinessCategory
	(*ivms101.LegalPerson)(nil),        // 5: ivms101.LegalPerson
	(*v1beta1.Contacts)(nil),           // 6: trisa.gds.models.v1beta1.Contacts
	(*v1beta1.TRIXOQuestionnaire)(nil), // 7: trisa.gds.models.v1beta1.TRIXOQuestionnaire
}
var file_bff_models_v1_models_proto_depIdxs = []int32{
	...
	4, // 3: bff.models.v1.RegistrationForm.business_category:type_name -> trisa.gds.models.v1beta1.BusinessCategory
	5, // 4: bff.models.v1.RegistrationForm.entity:type_name -> ivms101.LegalPerson
	6, // 5: bff.models.v1.RegistrationForm.contacts:type_name -> trisa.gds.models.v1beta1.Contacts
	7, // 6: bff.models.v1.RegistrationForm.trixo:type_name -> trisa.gds.models.v1beta1.TRIXOQuestionnaire
