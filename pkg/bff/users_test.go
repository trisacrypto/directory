...
func (s *bffTestSuite) TestNewUserLogin() {
	...
	require.Equal("Registration By Leopold Wentzel [Draft]", org.Name, "organization name does not match")
	require.Empty(org.CreatedBy, "organization should be auto-created")
