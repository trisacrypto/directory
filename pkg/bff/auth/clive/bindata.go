...
func faviconPng() (*asset, error) {
	...
	info := bindataFileInfo{name: "favicon.png", size: 1693, mode: os.FileMode(0644), modTime: time.Unix(1663788021, 0)}
...
func indexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.html", size: 7101, mode: os.FileMode(0644), modTime: time.Unix(1663788021, 0)}
