...
func deliver_certsHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deliver_certs.html", size: 1983, mode: os.FileMode(0644), modTime: time.Unix(1716396272, 0)}
...
func deliver_certsTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "deliver_certs.txt", size: 1585, mode: os.FileMode(0644), modTime: time.Unix(1716396281, 0)}
...
func verify_contactHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "verify_contact.html", size: 675, mode: os.FileMode(0644), modTime: time.Unix(1716397070, 0)}
...
func verify_contactTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "verify_contact.txt", size: 545, mode: os.FileMode(0644), modTime: time.Unix(1716397074, 0)}
