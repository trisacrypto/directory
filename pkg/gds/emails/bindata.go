...
func reject_registrationHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "reject_registration.html", size: 845, mode: os.FileMode(0644), modTime: time.Unix(1668625557, 0)}
...
func reject_registrationTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "reject_registration.txt", size: 600, mode: os.FileMode(0644), modTime: time.Unix(1668625539, 0)}
