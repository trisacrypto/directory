...
func review_requestHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "review_request.html", size: 1194, mode: os.FileMode(0644), modTime: time.Unix(1625067522, 0)}
...
func review_requestTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "review_request.txt", size: 970, mode: os.FileMode(0644), modTime: time.Unix(1625067522, 0)}
