...
func review_requestHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "review_request.html", size: 1225, mode: os.FileMode(0644), modTime: time.Unix(1634558347, 0)}
...
func review_requestTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "review_request.txt", size: 978, mode: os.FileMode(0644), modTime: time.Unix(1634558335, 0)}
