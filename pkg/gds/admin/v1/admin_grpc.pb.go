...
func (c *directoryAdministrationClient) Review(ctx context.Context, in *ReviewRequest, opts ...grpc.CallOption) (*ReviewReply, error) {
	out := new(ReviewReply)
	err := c.cc.Invoke(ctx, DirectoryAdministration_Review_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *directoryAdministrationClient) Resend(ctx context.Context, in *ResendRequest, opts ...grpc.CallOption) (*ResendReply, error) {
	out := new(ResendReply)
	err := c.cc.Invoke(ctx, DirectoryAdministration_Resend_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *directoryAdministrationClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, DirectoryAdministration_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
