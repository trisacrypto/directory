...
func (c *tRISAMembersClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListReply, error) {
	out := new(ListReply)
	err := c.cc.Invoke(ctx, TRISAMembers_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tRISAMembersClient) Summary(ctx context.Context, in *SummaryRequest, opts ...grpc.CallOption) (*SummaryReply, error) {
	...
	err := c.cc.Invoke(ctx, TRISAMembers_Summary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tRISAMembersClient) Details(ctx context.Context, in *DetailsRequest, opts ...grpc.CallOption) (*MemberDetails, error) {
	...
	err := c.cc.Invoke(ctx, TRISAMembers_Details_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
