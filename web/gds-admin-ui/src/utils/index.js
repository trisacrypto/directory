...
import { DIRECTORY, ENVIRONMENT, Status, VERIFIED_CONTACT_STATUS } from '@/constants';
...
function isOptionAvailable(verificationStatus = '') {
  ...
  return ['NO_VERIFICATION', 'SUBMITTED', 'EMAIL_VERIFIED', 'PENDING_REVIEW', 'ERRORED'].includes(
    verificationStatus
  );
}
