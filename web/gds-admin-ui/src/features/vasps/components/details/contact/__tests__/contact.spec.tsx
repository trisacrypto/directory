...
describe('Contact', () => {
    ...
    it('should be verified', () => {
        verifiedContact = {
            legal: 'Vita_VonRueden89@hotmail.com',
            technical: 'Vita_VonRueden89@hotmail.com',
        };
        type = faker.helpers.arrayElement(['legal', 'technical']);
        data = {
    ...
    it('should be alternate verified', () => {
        const verifiedContact = {
            administrative: 'Ozella_Crooks25@yahoo.com',
            billing: 'Vita_VonRueden89@hotmail.com',
        };
        const type = faker.helpers.arrayElement(['legal', 'technical']);
        const data = {
    ...
    it('should be unverified', () => {
        verifiedContact = {
            administrative: 'VonRueden89@hotmail.com',
            billing: 'Vita_VonRueden89@hotmail.com',
        };
        type = faker.helpers.arrayElement(['legal', 'technical']);
        data = {
