...
const schema = yup.object().shape({
  ...
  established_on: yup
    .date()
    .typeError('Date of Incorporation/Establishment should be a valid date')
    .required(),
});
...
function BusinessInfosForm({ data }) {
  ...
  return (
    <>
      ...
      <p>
        Please enter extended and basic details about the business entity. Note that the IVMS 101
        data contains the legal details and company name information.
      </p>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Form.Group as={Row} className="mb-2" controlId="vasp_categories">
          ...
          <Col sm="12">
            ...
            <Form.Text>
              Please select as many categories needed to represent the types of virtual asset
