...
function ButtonSpinner({ variant, isLoading, label, loadingMessage, ...rest }) {
    return <Button data-testid="deleteBtn" variant={variant} className={classNames('d-flex align-items-center justify-content-between gap-1', { 'py-0': isLoading })} disabled={isLoading} {...rest}>
        {
