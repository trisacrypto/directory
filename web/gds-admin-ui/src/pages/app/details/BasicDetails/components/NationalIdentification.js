        ...
        <Col>
            {
                data ? (
                    <Col className="mt-3">
                        ...
                        <hr className='my-1' />
                        <p className="mb-2 fw-bold">Issued by: <span className="fw-normal">{`${formatDisplayedData(countryCodeEmoji(data?.national_identification.country_of_issue))} (${formatDisplayedData(data?.national_identification?.country_of_issue)}) by authority ${formatDisplayedData(data?.national_identification?.registration_authority)}`}</span></p>
                        <p className="mb-1 fw-bold">National identification type: <span className="fw-normal badge bg-primary rounded-pill px-1">{formatDisplayedData(NATIONAL_IDENTIFIER_TYPE[data?.national_identification.national_identifier_type])}</span></p>
