...
function ReviewForm() {
    ...
    if (errorStatusCode === 404) {
        return <>
            <i className='mdi mdi-emoticon-sad-outline fs-2 text-center'></i>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            <Row>
                <Form.Group>
                    ...
                    <Form.Check {...register('accept')} value={true} type="radio" label="Accept" name="accept" id="accept" className='mb-1' />
                ...
                </Form.Group>
                {
                    isReject && (
                        <Form.Group className='mt-2'>
                            <Form.Control
                                as="textarea" rows={5}
                                isInvalid={!!errors["reject_reason"]} {...register('reject_reason', { required: 'Please enter the rejection reason' })}
