    ...
    return (
        <Card>
            <Card.Body>
                ...
                <p className='lh-lg' data-testid="financial-transfers-permitted">Organization <span className='fw-bold'>{financialTransfersPermitted[data?.financial_transfers_permitted]}</span> permitted to send and/or receive transfers of virtual assets in the jurisdictions in which it operates</p>
                <Row>
                    <Col xs={12} md={6}>
                        ...
                        <ul className='list-unstyled d-flex'>
                            ...
                            <ul className='list-unstyled'>
                                <li data-testid="primary-juridiction">
                                ...
                                </li>
                                {
                                    Array.isArray(data?.other_jurisdictions) && data?.other_jurisdictions?.map((juridiction, index) => {
                                        return (
                                            <li data-testid='other-juridiction' key={index}>{countryCodeEmoji(validateIsoCode(juridiction?.country))} {isoCountries[juridiction?.country]} regulated by {juridiction?.regulator_name}</li>
                                        )
                                    })
                                }
                            </ul>
