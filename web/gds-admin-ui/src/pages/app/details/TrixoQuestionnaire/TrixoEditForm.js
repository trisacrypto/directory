    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Form.Group as={Row} className="mb-3" controlId='conductsCustomerKYC'>
                <Form.Label column sm="12" className="fw-normal">
                    Does your organization conduct KYC/CDD before permitting its customers to send/receive virtual asset transfers?
                </Form.Label>
                <Col>
                    <Field.Switch
                        type="switch"
            ...
            <Form.Group as={Row} className="mb-3">
                ...
                <Form.Text>Threshold to conduct KYC before permitting the customer to send/receive virtual asset transfers
                </Form.Text>
            </Form.Group>

            <Form.Group as={Row} className="mb-3" controlId='mustComplyTravelRule'>
                <Form.Label column sm="12" className="fw-normal">
                    Is your organization required to comply with the application of the Travel Rule standards in the jurisdiction(s) where it is licensed/approved/registered?
                </Form.Label>
                <Col>
                    <Field.Switch
                        type="switch"
            ...
            <Form.Group as={Row} className="mb-3">
                ...
                <Form.Text>The minimum threshold above which your organization is required to collect/send Travel Rule information.
                </Form.Text>
            </Form.Group>
