...
describe("EmailLogo", () => {
    ...
    it('Should show email log data', () => {
        ...
        expect(screen.getByTestId('email-log-subject-line').textContent).toBe('subject: TRISA: Please verify your email address')
        ...
        expect(screen.getByTestId('email-log-timestamp').textContent).toBe('Mon, 08 Nov 2021 20:28:36 GMT')
    })
