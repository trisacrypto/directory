            ...
            <div className="w-100 overflow-hidden">
                <div className='d-flex justify-content-between pt-1'>
                    ...
                    <div>
                        ...
                        <button className='py-0 px-1 btn btn-danger'><i className='mdi mdi-trash-can-outline'></i> <small className='d-xs-none d-sm-none d-md-none d-lg-none d-xl-inline'>Delete</small></button>
                    </div>
                </div>
                <div>
                    {note.text}
