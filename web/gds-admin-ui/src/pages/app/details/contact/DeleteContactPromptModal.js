...
function DeleteContactPromptModal({ type, onDelete }) {
    ...
    return <>
        <p className='text-center'>Are you sure you want to delete the <span className='fw-bold'>{type}</span> contact?</p>
        ...
        <Row>
            ...
            <Col className='text-center'>
                <Button onClick={onDelete} variant='danger' disabled={isLoading}>Delete</Button>
            </Col>
        </Row>
    </>;
}
