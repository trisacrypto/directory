...
import RowItem from "../TableRow/RowItem";
                ...
                <Table variant="unstyled" css={{ borderCollapse: 'separate', borderSpacing: '0 9px' }}>
                    <TableCaption placement="top" textAlign="start" p={0} m={0} >
                        <Stack direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
                            ...
                            <FormButton borderRadius={5}>Request New Sealing Certificate</FormButton>
                        </Stack>
                    </TableCaption>
                    <Thead>
                        <Tr>
