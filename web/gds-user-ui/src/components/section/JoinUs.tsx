...
const datas = [
  {
    ...
    content: (
      <>
        TRISA uses public-key cryptography for encrpyting data in flight and at rest.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        TRISA is open source and available to implement by any VASPs.
      </>
    ),
  },
  {
        ...
        <Stack >
          <Stack
            ...
            <Box mb={{ base: 10, md: 25 }}
              ...
              <Text fontSize={'xl'}  >
              TRISA is the only global, open source, peer-to-peer and secure Travel Rule network. Become a TRISA-certified VASP today. Learn how TRISA works.
              </Text>
            </Box>
            ...
            <Box alignItems="center"  textAlign="center" >
              <Button  bg="#FF7A59" w="306px" h="64px" color="white" borderColor="white" border="2px" _hover={{bg:'#FF7A77'}} >Join Today</Button>
