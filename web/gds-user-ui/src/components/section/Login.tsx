      ...
      <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6} width={'100%'}>
        ...
        >
          <Button
            ...
            w="100%" height={'64px'}
            color={'gray.600'}
            _hover={{ background: useColorModeValue('gray.200', 'black'), color: useColorModeValue('gray.600', 'white') }}
            _focus={{
          ...
          <Stack spacing={4} >
            ...
            <Stack spacing={8} direction={['column', 'row']} py='10'>
              ...
              >
                ...
                <Text lineHeight='57px' > <Link href='/forget' > Forgot password? </Link></Text>
