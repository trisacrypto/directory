          ...
          <Box mt={20} pt={10}>
            <Stack
              ...
              <Line title="Option 1. Set Up Your Own TRISA Node" fontWeight={'bold'}>
                Since TRISA is an open source, peer-to-peer Travel Rule solution, VASPs can set up
                and maintain their own TRISA server to exhange encrypted Travel Rule compliance
                data. TRISA maintains an GitHub repository with detailed documentation, a reference
                implemenation, and “robot” VASPs for testing purposes.
              </Line>
              ...
              <Line title="How to set up your own node?" fontWeight={'bold'}>
                Talk to a member of your technical team to determine the requirements and resources
                to integrate TRISA with your system. Have members of your technical team integrate
                your systems with TRISA. Or work with a solutions provider that can help your VASP
