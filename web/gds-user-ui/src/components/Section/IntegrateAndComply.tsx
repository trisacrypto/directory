            ...
            <Box mt={20} pt={10}>
              <Stack
                ...
                <Line title="Option 1. Set Up Your Own TRISA Node" fontWeight={'bold'}>
                  ...
                  data. TRISA maintains an GitHub repository with detailed documentation, a
                ...
                <Line title="How to set up your own node?" fontWeight={'bold'}>
                  ...
                  resources to integrate TRISA with your system. Have members of your technical team
                  integrate your systems with TRISA. Or work with a solutions provider that can help
                  your VASP set up your TRISA server and maintain it.
                </Line>
